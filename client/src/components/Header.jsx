...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className='text-4xl max-w0[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      >
        ...
        className='mt-2 text-neutral-600'>Generated images from AakrutI</motion.p>
